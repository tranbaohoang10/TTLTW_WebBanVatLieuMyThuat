...
public class OrderTrackingController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("trackingStatusText", mapTrackingStatus(statusRaw));
        request.setAttribute("trackingLeadtimeText", formatIsoTime(leadtimeRaw));
        request.setAttribute("trackingUpdatedTimeText", formatIsoTime(order.getGhnUpdatedTime()));
        request.setAttribute("trackingWarehouseText", order.getGhnWarehouse());
